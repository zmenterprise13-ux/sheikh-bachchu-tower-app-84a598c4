        ...
        <TooltipProvider>
          ...
          <Router>
            ...
            <Routes>
              ...
              <Route path="/admin/user-management" element={<ProtectedRoute allowRoles={["admin", "manager"]}><AdminUserManagement /></ProtectedRoute>} />
              ...
              <Route path="/owner/online-payments" element={<ProtectedRoute allowRoles={["owner","tenant"]}><OwnerOnlinePayments /></ProtectedRoute>} />
