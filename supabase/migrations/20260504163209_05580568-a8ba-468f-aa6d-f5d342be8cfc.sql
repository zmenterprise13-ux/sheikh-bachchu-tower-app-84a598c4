...
-- Extend publish_monthly_report snapshot to include detailed style-1 data
...
BEGIN
  ...
  -- Style-1: flat total buckets (amount × count)
  ...
  -- Style-1: bill component buckets per category
  ...
  -- Opening cash: anchor + activity strictly before _start
...
-- Default app_setting for report style (admin-controlled, owners view in MonthlyFinanceSummary)
INSERT INTO public.app_settings (key, value)
VALUES ('owner_report_style', '{"style":"detailed"}'::jsonb)
